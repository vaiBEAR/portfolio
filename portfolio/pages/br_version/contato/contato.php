                ...
                <div class="text-white">
                    ...
                    <div class="mt-1 p-5 bg-primary text-white rounded">
                        <form action="action.php" id="form1" name="form1" method="POST">
                            ...
                            <label for="matter">Assunto</label>
                            <input type="text" placeholder="Sobre..." name="assunto" id="assunto">

                            <label for="message">Mensagem</label>
                            <textarea name="mensagem" id="mensagem" style="height:200px" placeholder="Escreva aqui..."></textarea>
